...
public class LaboratoryManager implements Serializable, AuthenticationListener {
    ...
    public StreamedContent getPurchaseReqStreamContent(EntityManager em) {
        ...
        try {
            ...
            // tk get the user's org. here and fill in the value
            parameters.put("logoURL", "");
            
            // tk get the user's org. here and fill in the values 
            parameters.put("orgAddressLine1", "");
            parameters.put("orgAddressLine2", "");
    ...
    public void editSelectedPurchaseReq() {
        ...
        PrimeFacesUtils.openDialog(null, "purchreqDialog", true, true, true, false, 700, 900);
    }
